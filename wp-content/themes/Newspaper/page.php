                            ...
                            <div class="td-ss-main-content">
                                ...
                                if (have_posts()) {
                                    while ( have_posts() ) : the_post();
                                        ...
                                        if(is_page("fertibilidad")){
                                            include(dirname(__FILE__)."/herramientas/fertibilidad.php");
                                        }else if(is_page("fecha-ovulacion")){
                                            include(dirname(__FILE__)."/herramientas/fechaovulacion.php");
                                        }else if(is_page("fecha-parto")){
                                            include(dirname(__FILE__)."/herramientas/fechaparto.php");
                                        }else if(is_page("sexo-bebe")){
                                            include(dirname(__FILE__)."/herramientas/sexobebe.php");
                                        }else if(is_page("gestograma")){
                                            include(dirname(__FILE__)."/herramientas/gestograma.php");
                                        }else if(is_page("buscador-de-nombres")){
                                            include(dirname(__FILE__)."/herramientas/buscador_nombres.php");
                                        }else{
                                            the_content();
                                        }
